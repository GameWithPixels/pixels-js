...
/**
 * Base class for errors thrown by the {@link PixelType} class.
 * @category Pixels
 */
export class PixelError extends Error {
  /** The PixelType for which the error occurred. */
  ...
  constructor(pixel: PixelType, message: string, cause?: Error) {
    ...
    // Initialize instance
    super(`PixelType ${pixel.name}: ${message}`);
...
/**
 * Base class for errors thrown by the {@link PixelType.connect} instance method.
 * @category Pixels
 */
...
/**
 * Thrown by {@link PixelType.connect} on connection timeout.
 * @category Pixels
 */
...
/**
 * Thrown by {@link PixelType.connect} on connection error caused by a cancellation
 * (such as a call to {@link PixelType.disconnect} during the connection sequence).
 * @category Pixels
 */
...
/**
 * Thrown by {@link PixelType.connect} on connection error caused by a PixelType id
...
/**
 * Thrown by methods of the {@link PixelType} class on errors caused by a timeout
...
/**
 * Thrown by methods of the {@link PixelType} class on errors caused by a disconnection
 * while waiting for a message from the die.
 * @category Pixels
 */
...
/**
 * Thrown by methods of the {@link PixelType} class when trying to send a message which
...
/**
 * Thrown by {@link PixelType.rename} method when an empty name is passed.
 * @category Pixels
 */
export class PixelEmptyNameError extends PixelError {
  constructor(pixel: PixelType) {
    super(pixel, "New PixelType name must have at least one character");
    this.name = "PixelEmptyNameError";
  }
}

/**
 * Base class for errors thrown by {@link PixelType} data transfer instance methods.
 * @category Pixels
 */
...
/**
 * Thrown by {@link PixelType} data transfer instance methods.
 * @category Pixels
 */
