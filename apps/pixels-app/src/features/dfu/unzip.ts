...
import dfuBetaFiles from "#/dfu-beta-files.zip";
...
export async function unzipEmbeddedDfuBetaFilesAsync(): Promise<string[]> {
  // Clear existing files
  return await unzipDfuFilesFromAssetsAsync(dfuBetaFiles, {
    clearCache: true,
  });
}
